...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "Akses desktop Anda dengan ID dan kata sandi berikut"),
        ("Password", "Kata sandi"),
        ("Ready", "Sudah siap"),
        ...
        ("Do you want to enter again?", "Apakah Anda ingin mencoba lagi?"),
        ...
        ("Are you sure you want to delete this file?", "Apakah Anda yakin ingin menghapus file ini?"),
        ...
        ("config_acc", "Agar desktop Anda dapat dikontrol dari jarak jauh, Anda harus memberikan izin \"Aksesibilitas\" untuk RustDesk."),
        ("config_screen", "Agar desktop Anda dapat diakses dari jarak jauh, Anda harus memberikan izin \"Perekaman Layar\" untuk RustDesk."),
        ...
        ("agreement_tip", "Dengan memulai proses instalasi, Anda menyetujui perjanjian lisensi."),
        ("Accept and Install", "Terima dan Install"),
        ("End-user license agreement", "Perjanjian lisensi pengguna"),
        ("Generating ...", "Memproses..."),
        ("Your installation is lower version.", "Anda menggunakan versi instalasi yang lebih lama."),
        ...
        ("install_daemon_tip", "Untuk dapat berjalan saat sistem menyala, Anda perlu menginstal layanan sistem (system service/daemon)."),
        ("Remote ID", "ID Remote"),
        ("Paste", "Tempel"),
        ("Paste here?", "Tempel disini?"),
        ("Are you sure to close the connection?", "Apakah Anda yakin ingin menutup koneksi?"),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Anda harus memberikan izin kepada RustDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ...
        ("clear_Wayland_screen_selection_tip", "Setelah mengosongkan pilihan layar, Anda dapat memilih kembali layar untuk dibagikan"),
        ("confirm_clear_Wayland_screen_selection_tip", "Apakah Anda yakin ingin membersihkan pemilihan layar Wayland?"),
        ("android_new_voice_call_tip", "Anda menerima permintaan panggilan suara baru. Jika diterima, audio akan berubah menjadi komunikasi suara."),
        ("texture_render_tip", "Aktifkan rendering tekstur untuk membuat tampilan gambar lebih mulus. Anda dapat menonaktifkan opsi ini jika terjadi masalah saat merender."),
        ...
        ("enable-bot-tip", "Jika fitur ini diaktifkan, Anda dapat menerima kode 2FA dari bot, serta mendapatkan notifikasi tentang koneksi."),
        ("enable-bot-desc", "1. Buka chat dengan @BotFather.\n2. Kirim perintah \"/newbot\". Setelah menyelesaikan langkah ini, Anda akan mendapatkan token\n3. Mulai percakapan dengan bot yang baru dibuat. Kirim pesan yang dimulai dengan garis miring (\"/\") seperti \"/hello\" untuk mengaktifkannya."),
        ("cancel-2fa-confirm-tip", "Apakah Anda yakin ingin membatalkan 2FA?"),
        ("cancel-bot-confirm-tip", "Apakah Anda yakin ingin membatalkan bot Telegram?"),
        ...
        ("download-new-version-failed-tip", "Gagal mendownload. Anda dapat mencoba lagi nanti atau klik tombol \"Download\" untuk melakukan download dari halaman rilis dan memperbarui versi secara manual."),
